...
* **0x2008 - 0x3FFF**: PPU Register copy.
...
| instruction | Addressing Mode | ASM          | Opcode | Bytes | cycles |
| ----------- | --------------- | ------------ | ------ | ----- | ------ |
...
|             | Zero Page,Y     | LDY Oper,X   | B4     | 2     | 4      |
|             | Absolute        | LDY Oper     | AC     | 3     | 4      |
|             | Absolute,Y      | LDY Oper,X   | BC     | 3     | 4*     |
...
| STX         | Zero Page       | STX Oper     | 86     | 2     | 3      |
|             | Zero Page,Y     | STX Oper,Y   | 96     | 2     | 4      |
|             | Absolute        | STX Oper     | 8E     | 3     | 4      |
| STY         | Zero Page       | STY Oper     | 84     | 2     | 3      |
